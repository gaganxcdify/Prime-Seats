        ...
        {isLoggedIn ? (
          <>
            {isAdmin && (
              <>
                <li>
                  <NavLink to="/addcity" className="nav-button">
                    ADD CITY
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/addtheater" className="nav-button">
                    ADD THEATER
                  </NavLink>
                </li>
                <li>
            ...
            <li>
              {isAdmin ? (
                <NavLink to="/admindetails" className="icon nav-button">
                  <CgProfile />
                </NavLink>
              ) : (
                <NavLink to="/userdetails" className="icon">
                  <CgProfile />
                </NavLink>
              )}
            </li>
